...
;(function ( $, window, document, undefined ) {
  ...
  var $cs_body, $cs_html, $cs_main, $cs_masthead, $cs_window, $cs_document,
      ...
      cs_is_blank, cs_no_mobile_anim, cs_click_event, cs_sticky_height, cs_admin_bar_height, cs_header_height, cs_header_top;
  ...
  ROUTE.staticVariables = function() {
    ...
    cs_click_event      = ( document.ontouchstart !== null ) ? 'click' : 'touchstart';
    ...
    cs_header_top       = ( $cs_masthead ) ? $cs_masthead.offset().top : 0;
  ...
  ROUTE.mobileNavigation = function(){
    ...
    $('#cs-mobile-icon').on(cs_click_event, function( e ){
    ...
    $('#navigation-mobile li:has(ul) > .cs-dropdown-plus').on(cs_click_event, function( e ){
    ...
    $('#navigation-mobile li:has(ul) > a').on(cs_click_event, function( e ){
  ...
  ROUTE.topModals = function(){
    ...
    $('.cs-top-modal').each(function() {
      ...
      $open.on(cs_click_event, function( e ) {
      ...
      $content.on(cs_click_event, function ( event ) {
  ...
  ROUTE.isotopeInitalize = function() {
    ...
    $('.isotope-container').each( function(){
      ...
      $iso_filter.on(cs_click_event, function( e ){
        e.preventDefault();
  ...
  ROUTE.ajaxPagination = function() {
    ...
    $('.ajax-load-more').each(function() {
      ...
      $this.bind(cs_click_event, function() {
  ...
  ROUTE.ajaxPortfolio = function(){
    ...
    $('.portfolio-model-ajax').each( function() {
      ...
      $this.on(cs_click_event, '.item-ajax-load', function( e ) {
        e.preventDefault();
      ...
      $this.on(cs_click_event, '.ajax-close', function( e ) {
        e.preventDefault();
  ...
  ROUTE.postLove = function(){
    ...
    $cs_body.on(cs_click_event, '.entry-love-it', function( e ) {
      e.preventDefault();
  ...
  ROUTE.onePage = function() {
    ...
    $('.cs-start').each( function() {
      $(this).on(cs_click_event, function( e ) {
        e.preventDefault();
    ...
    if( $cs_body.hasClass('page-template-templatespage-one-page-php') ) {
      ...
      $('#site-logo a').on(cs_click_event, function( e ) {
        e.preventDefault();
  ...
  ROUTE.csAccordion = function() {
    ...
    $('.cs-accordions').each(function() {
      ...
      $wrap.each( function() {
        ...
        $accordion.on(cs_click_event, '.cs-accordion-title:not(.selected)', function( e ) {
          e.preventDefault();
  ...
  ROUTE.csToggle = function() {
    ...
    $('.cs-toggle').each(function() {
      ...
      $this.on(cs_click_event, '.cs-toggle-title', function( e ) {
        e.preventDefault();
  ...
  ROUTE.csAlert = function() {
    ...
    $('.cs-alert-dismissable').each(function() {
      var $this = $(this);
      $this.on(cs_click_event, '.cs-alert-close', function( e ) {
        e.preventDefault();
  ...
  ROUTE.csFaq = function() {
    ...
    $('.cs-faq').each(function() {
      ...
      $faq_filter.on(cs_click_event, function( e ) {
  ...
  ROUTE.bsModal = function() {
    ...
    $('.bs-modal').each( function() {
      ...
      var $modal = $(this);
      $( $modal.data('selector') ).on( cs_click_event, function( e ) {
        e.preventDefault();
        $modal.modal();
      });
