...
add_shortcode_param('vc_cs_on_off', 'vc_cs_on_off');
...
add_shortcode_param('vc_cs_textfield', 'vc_cs_textfield');
...
add_shortcode_param('vc_cs_icon', 'vc_cs_icon');
...
add_shortcode_param('vc_cs_image_select', 'vc_cs_image_select');
...
add_shortcode_param('vc_cs_content', 'vc_cs_content');
...
add_shortcode_param('vc_cs_upload', 'vc_cs_upload');
...
add_shortcode_param('vc_cs_exploded_textarea', 'vc_cs_exploded_textarea');
...
add_shortcode_param('vc_cs_style_textarea', 'vc_cs_style_textarea');
...
add_shortcode_param('vc_cs_shortcode_textarea', 'vc_cs_shortcode_textarea');
...
add_shortcode_param('vc_cs_chosen', 'vc_cs_chosen');
...
add_shortcode_param('vc_cs_color_picker', 'vc_cs_color_picker');